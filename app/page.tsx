...
export default function HomePage() {
  return (
    <>
      ...
      <main className='container-shell py-10 md:py-16 lg:py-20'>
        <section className='mx-auto max-w-5xl'>
          ...
          <p className='page-subtitle mt-5 max-w-3xl'>
            ...
            pets. Through memories, conversations, and emotional connection, every interaction feels
            warm, personal, and familiar.
          </p>
