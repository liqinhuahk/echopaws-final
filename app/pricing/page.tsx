      ...
      <main className='container-shell py-10'>
        <section className='text-center'>
          ...
          <p className='section-subtitle'>
            EchoPaws membership is not about more messages — it is about being
            understood. The longer you stay, the more it is worth it.
          </p>
        </section>
        ...
        {searchParams?.checkout === 'cancelled' ? (
          <div className='mt-6 rounded-2xl bg-amber-50 px-4 py-3 text-sm font-bold text-amber-900'>
            Subscription cancelled. You can resubscribe anytime to unlock VIP.
          </div>
        ) : null}
        ...
        <section id='plans' className='mt-8 grid gap-5 md:grid-cols-2'>
          <article className='glass-card p-6'>
            ...
            <div className='mt-4 flex items-end gap-2'>
              <strong className='text-5xl font-extrabold tracking-[-0.05em]'>$0</strong>
            ...
            <a
              ...
              className='subtle-button mt-6 w-full'
            >
              Try It Free
            </a>
          </article>
          ...
          <article className='glass-card relative overflow-hidden bg-gradient-to-b from-orange-50 to-amber-50 p-6'>
            ...
            <div className='mt-4 flex items-end gap-2'>
              <strong className='text-5xl font-extrabold tracking-[-0.05em]'>$9</strong>
              <span className='mb-1 text-muted'>/ mo</span>
            </div>
        ...
        <section className='mt-8 grid gap-5 md:grid-cols-2'>
          <div className='glass-card bg-card-gradient p-6'>
            ...
            <p className='mt-3 text-lg leading-9'>
              Not because it answers more questions — but because it feels like
              their pet, uniquely theirs. Value is built around relationship depth,
              memory quality, and companionship style, not message count.
            </p>
          </div>
