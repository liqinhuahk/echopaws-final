...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'hero-wash':
          'radial-gradient(circle at 10% 10%, rgba(245,158,11,.10), transparent 30%), radial-gradient(circle at 90% 0, rgba(249,115,22,.08), transparent 28%), linear-gradient(180deg,#fffaf3 0%,#faf7f2 40%,#f8f4ee 100%)',
